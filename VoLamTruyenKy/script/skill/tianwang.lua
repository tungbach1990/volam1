...
SKILLS={
	...
	duanhun_ci={ --断魂刺
		...
		missle_speed_v={{{1,22},{20,30}}},
		skill_attackradius={{{1,22*16},{20,30*16}}},
		skill_cost_v={{{1,10},{20,20}}}
	},
	xuezhan_bafang={ --血战八方
	...
	jinzhong_zhao={ --金钟罩
		...
		fireres_p={{{1,-5},{20,-15}},{{1,18*120},{20,18*180}}},
		skill_cost_v={{{1,12},{20,40}}}
	},
	chenglong_jue={ --乘龙诀
		physicsenhance_p={{{1,40},{20,495}}},
		ignoredefense_p={{{1,38},{20,80}}},
		seriesdamage_p={{{1,10},{20,50}}},
		colddamage_v={
			[1]={{1,10},{20,100}},
			[3]={{1,20},{20,200}}
