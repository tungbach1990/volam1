...
SKILLS={
	...
	budong_mingwang={ --不动明王
		attackratingenhance_p={{{1,28},{20,275}},{{1,18*120},{20,18*120}}},
		adddefense_v={{{1,15},{20,250}},{{1,18*120},{20,18*120}}},
		skill_cost_v={{{1,10},{20,40}}}
	},
	shizi_hou={ --狮子吼
		stun_p={{{1,14},{20,33}},{{1,2},{20,18}}},
		physicsdamage_v={
			[1]={{1,45},{20,140}},
			[3]={{1,45},{20,140}}
		},
	...
	rulai_qianye={ --如来千叶
		...
		lifemax_p={{{1,3},{30,80}},{{1,18*120},{30,6480}}},
		addcolddamage_v={{{1,10},{30,215}},{{1,18*120},{30,6480}}},
		deadlystrikeenhance_p={{{1,5},{30,15}},{{1,18*120},{30,6480}}},
		attackspeed_v={{{1,35},{30,65}},{{1,18*120},{30,6480}}},
		skill_cost_v={{{1,15},{30,45}}}
	},
	damo_dujiang={ --达摩渡江
		physicsenhance_p={{{1,55},{15,345},{20,482}}},
		seriesdamage_p={{{1,20},{15,20},{20,60}}},
		ignoredefense_p={{{1,9},{20,90}}},
		skill_cost_v={{{1,15},{20,35}}},
		colddamage_v={
			[1]={{1,10},{20,155}},
			[3]={{1,10},{20,155}}
